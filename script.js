...
function setVolume(volume) {
    audio.volume = volume; // Volume range is 0.0 to 1.0
}
...
function startFireworksAfterDelay() {
    setTimeout(light_blue_touchpaper, delay);
}

// Start the fireworks after the delay
startFireworksAfterDelay();